...
with st.expander("Check z/OSMF Connection"):

    col01, col02, col03, col04, col00 = st.columns([1, 1, 1, 1, 5], vertical_alignment="top")
...
with st.expander("Check JWT Connection"):

    col11, col12, col13, col14, col15, col10 = st.columns([1, 1, 1, 1, 1, 4], vertical_alignment="top")
